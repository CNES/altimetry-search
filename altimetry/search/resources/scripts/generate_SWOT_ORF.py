...
cluster = dask_jobqueue.SLURMCluster(
    cores=1,
    memory=
    '8GiB',  # Balanced configuration should have 8 GiB per core if possible
    processes=1,
    walltime='00:30:00',
    interface='ib0',
...
db = open_collection(
    '/work/HELPDESK_SWOTLR/commun/data/swot/L3_LR_SSH/zcollections/V3.0_CALVAL'
)
ds = db.query(cycle_numbers=range(474, 579),
              selected_variables=('time', 'cycle_number', 'pass_number'))
